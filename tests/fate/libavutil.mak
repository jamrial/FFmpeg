...
FATE_LIBAVUTIL += fate-crc64
fate-crc64: libavutil/crc64-test$(EXESUF)
fate-crc64: CMD = run libavutil/crc64-test
...
FATE_LIBAVUTIL += fate-md4
fate-md4: libavutil/md4-test$(EXESUF)
fate-md4: CMD = run libavutil/md4-test
